...
//+kubebuilder:rbac:groups=watcher.reqauth.com,resources=reqauthwatchers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=watcher.reqauth.com,resources=reqauthwatchers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=watcher.reqauth.com,resources=reqauthwatchers/finalizers,verbs=update
...
func (r *ReqAuthWatcherReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	watcher := &watcherv1.ReqAuthWatcher{}
...
func (r *ReqAuthWatcherReconciler) reconcileAuthorizationPolicy(ctx context.Context, watcher *watcherv1.ReqAuthWatcher, l logr.Logger) error {
...
func Build(ra *v12.RequestAuthentication, reqAuth *watcherv1.ReqAuthWatcher, l logr.Logger) *v12.RequestAuthentication {
